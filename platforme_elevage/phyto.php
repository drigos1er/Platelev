        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper  brown darken-1">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="images/" alt=""></a></h1></li>
                    </ul>
                ...
                <div class="col col s8 m8 l8">
                  ...
                  <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-image-blur-circular"></i> Produit D'Elevage</a>
                        ...
                        <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-blur-circular"></i>Produits Phytosanitaire</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li class="active"><a href="engrais.php">Engrais</a>
                                    </li>
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-image-blur-circular"></i>Produits Agricole</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="mais.php">Mais</a>
                                    </li>
                                    <li><a href="haricot.php">Haricot</a>
                                    </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
               <h5 class="breadcrumbs-title">Phyto-Sanitaire</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.php">Menu</a>
                  </li>
                  <li><a href="#">Phyto-Sanitaire</a>
                  </li>
                  <li class="active">Engrais</li>
                </ol>
              </div>
            </div>
          </div>
