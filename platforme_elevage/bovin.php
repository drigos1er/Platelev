                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-image-blur-circular"></i> Produit D'Elevage</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li  class="active"><a href="bovin.php">Bovin</a>
                                    </li>
              ...
              <div class="col s12 m12 l12">
               <h5 class="breadcrumbs-title">Elevage</h5>
                <ol class="breadcrumbs">
                  ...
                  <li><a href="agri.php">Produits_Elevage</a>
                  </li>
                ...
                <div class="product">
                    <div class="card">
                        ...
                        <ul class="card-action-buttons">
                            ...
                            <li><a href="vue.php" class="btn-floating waves-effect waves-light red accent-2"><i class="mdi-action-favorite"></i></a>
                            </li>
